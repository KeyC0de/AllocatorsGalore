...
#pragma warning(suppress: 6385 6001)
	...
	// In STL we have a default rebinding mechanism so we don't need to write our own. But we will here for demo purposes.
	std::cout << "\nCustom allocator\n================\n";
	...
	std::cout << "max size = " << v.get_allocator().max_size() << '\n';
	...
	std::cout << "\nNon-aggregates" << '\n';
	// alignment and size of a variable of fundamental:
	...
	//If we want to align each element of an array there is a workaround.We can use an array of structures and align the structure itself
	...
	saa.construct(ps, "My name is Maximus Decimus Meridius.\n"
