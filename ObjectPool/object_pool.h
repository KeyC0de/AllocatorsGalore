...
public:
	...
	/// \brief constructor creates the pool given its size
	...
	/// \brief remove object from the list
	void deallocate(T* p, [[maybe_unused]] std::size_t count = 0) noexcept
	{
...
bool operator==(const ObjectPool<T>& lhs, const ObjectPool<Other>& rhs) noexcept
{
