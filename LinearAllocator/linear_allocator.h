...
// \date	26/9/2019
//
// allocates memory in a linear way; simply adjusting an offset we make memory available
...
public:
	...
	template<typename Other,
		std::size_t OtherAlignment = getAlignment()>
	struct rebind
	{
