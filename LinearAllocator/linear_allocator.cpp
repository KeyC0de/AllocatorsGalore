...
int main()
{
	...
	*pint = 1453;
	...
	// TODO: for some reason this doesn't work in release mode!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	for ( int i = 0; i < 64; i++ )
	{
		std::cout << (palignedInts + sizeof(AlignedInt) * i)->aint
			<< ' '
			<< isAligned( ( palignedInts + sizeof( AlignedInt ) * i ), intAlignment )
			<< '\n';
	}
	// it's aligned!
	// up to here!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	std::cout << lstr
		<< '\n';
	std::cout << "isAligned(lstr.data(), 128)="
		<< isAligned( lstr.data(), 128 )
		<< '\n';	// address on the dynamically allocated string
	std::cout << "isAligned(&lstr, 128)="
		<< isAligned( &lstr, 128 )
	...
	std::cout << "sizeof(LinearAllocator<GameObject,64>)="
		<< sizeof( LinearAllocator<GameObject, 64> )
		<< '\n';
